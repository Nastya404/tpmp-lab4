...
void print_menu(User *u) {
    ...
    if (is_admin) {
        printf("=== УПРАВЛЕНИЕ (только для администратора) ===\n");
        printf("1.  Добавить водителя\n");
        printf("2.  Добавить автомобиль\n");
        printf("5.  Обновить пробег автомобиля\n");
        printf("10. Отчёт: самый неактивный водитель\n");
        printf("11. Расчёт зарплаты конкретному водителю\n");
        printf("12. Просмотр таблицы начисленных зарплат\n\n");
    }

    printf("=== МОИ ДАННЫЕ И ОТЧЁТЫ (доступно водителю и администратору) ===\n");
    printf("3.  Создать заказ\n");
    printf("4.  Рассчитать зарплаты всем водителям за период\n");
    printf("6.  Отчёт: машина с максимальным пробегом\n");
    printf("7.  Отчёт: статистика по конкретной машине\n");
    printf("8.  Отчёт: мои заказы за период\n");
    printf("9.  Отчёт: статистика по всем водителям\n");
